...
import KioskMains from './pages/KioskMain/';
import KioskDetails from './pages/KioskDetails/';
...
const HOST = 'localhost:5000'; //'192.168.0.82:3001';
...
const App = () => {
  ...
  // useState(): 새로운 state변수를 선언한다, 반환값은 state변수와 갱신할 수 있는 함수
  // useState()안에는 초기값 설정
