        ...
        <Grid container direction="column">
          ...
          <Grid item className="text">
            <Grid>
              ...
              <p>
                Gola la Gola 계정을 생성함으로써 모바일 기기, 모바일
                애플리케이션 또는 컴퓨터(총체적으로 "서비스")를 통해 귀하가 본
                계약에 동의하는지 여부, (ii) 본 계약에 참조되어 있는 개인 정보
                보호 정책 및 안전 팁 및 (iii) 구입 시 공개되고 동의한 모든
                조건에 동의하는지 여부서비스에서 제공하는 이온 기능, 제품 또는
                서비스(총체적으로 이 "협정") 본 계약의 모든 조항에 동의하지 않고
                구속에 동의하는 경우 서비스를 사용하지 마십시오.
              </p>
              {/* <p>
                By creating an Gola la Gola account, whether through a mobile
            ...
            <Grid>
              ...
              {/* <h2>Your Account.</h2> */}
              <p>
                Gola la Gola를 사용하기 위해서는 페이스북, 인스타그램,
                구글("소셜 미디어") 로그인을 사용하여 로그인할 수 있다. 그렇게
                할 경우, 귀하는 귀하의 공개 소셜 미디어 프로필 및 소셜 미디어
                또는 Gola la Gola 사용자에게 개인 정보 사용 권한을 부여한 다른
                Gola la Gola 사용자와 공통적으로 공유하는 소셜 미디어 친구에
                대한 정보를 포함하되 이에 국한되지 않는 특정 소셜 미디어 계정
                정보에 액세스하여 사용할 수 있도록 당사에 권한을 부여하십시오.
                귀하로부터 수집된 정보 및 사용 방법에 대한 자세한 내용은 당사의
                개인 정보 보호 정책을 참조하십시오.
              </p>
              {/* <p>
                In order to use Gola la Gola, you may sign in using your
                ...
                you share in common with other Gola la Gola users who have given
                Social Media or Gola la Gola permission to use their personal
              ...
              <p>
                귀하는 Gola la Gola에 등록하기 위해 사용하는 로그인 자격 증명의
              ...
              {/* <p>
                ...
                login credentials you use to sign up for Gola la Gola, and you
            ...
            <Grid>
              ...
              {/* <p>
                ...
                with you. Gola la Gola is not responsible or liable for such
