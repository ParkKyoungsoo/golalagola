  ...
  return (
    <>
      <Wrapper>
        ...
        <Grid className="quizCentering">
          <button className="button1" onClick={click(true)} style={userAns === true ? buttonStyle : null}><img className="tmp" src={Test.answers[0]} alt="quiz" /></button>
          <button className="button2" onClick={click(false)} style={userAns === false ? buttonStyle : null}><img className="tmp" src={Test.answers[1]} alt="quiz" /></button>
        </Grid>
      </Wrapper>
      {userAns ?
        <Dialog
